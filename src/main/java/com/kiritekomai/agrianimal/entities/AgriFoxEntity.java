...
public class AgriFoxEntity extends AgrianimalEntity{
	...
	abstract class BaseGoal extends Goal {
		...
		protected boolean func_220813_g() {
			BlockPos blockpos = new BlockPos(AgriFoxEntity.this.getPosX(), AgriFoxEntity.this.getBoundingBox().maxY, AgriFoxEntity.this.getPosZ());
	...
	class SwimGoal extends net.minecraft.entity.ai.goal.SwimGoal {
		 ...
		 */
		public boolean shouldExecute() {
			return AgriFoxEntity.this.isInWater() && AgriFoxEntity.this.func_233571_b_(FluidTags.WATER) > 0.25D || AgriFoxEntity.this.isInLava();
		}
	}
